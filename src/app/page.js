...
export default function Home() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-gray-100 p-4">
            {/* Full-Width Title with Navbar */}
            <div className="w-full bg-gray-800 p-4 fixed top-0 left-0 shadow-lg flex justify-center items-center">
                <h1 className="text-3xl font-bold text-center">ChatFTC</h1>
                {/* Navbar */}
                <nav className="ml-12">
                    <Link href="/" className="text-gray-100 hover:text-gray-300 text-lg font-bold" passHref>
                        Game Manual
                    </Link>
                    <Link href="/programming" className="text-gray-100 hover:text-gray-300 text-lg ml-12" passHref>
                        Programming
                    </Link>
                </nav>
            </div>
